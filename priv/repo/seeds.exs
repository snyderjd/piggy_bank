...
alias PiggyBank.{Account, AccountType, Currency, LedgerEntry, Repo, Transaction, User}
...
_credit_checking_1000 = Repo.insert!(%Transaction{
...
_debit_checking_250 = Repo.insert!(%Transaction{
  transaction_type: "debit",
  amount: 250.00,
  date: NaiveDateTime.new!(2024, 4, 14, 0, 0, 0),
  account: warren_buffett_checking,
...
_credit_ds_100 = Repo.insert!(%Transaction{
  transaction_type: "credit",
  amount: 100.00,
  date: NaiveDateTime.new!(2024, 4, 15, 0, 0, 0),
...
_debit_wb_5 = Repo.insert!(%Transaction{
  transaction_type: "debit",
  amount: 5.00,
  date: NaiveDateTime.new!(2024, 4, 18, 0, 0, 0),
  account: warren_buffett_checking,
...
ds_fee_5 = Repo.insert!(%LedgerEntry{
  description: "credit Fee Revenue 5, debit Dwight Schrute Checking 5",
  date: NaiveDateTime.new!(2024, 4, 18, 0, 0, 0)
})

_credit_fee_revenue_5_ds = Repo.insert!(%Transaction{
  transaction_type: "credit",
  amount: 5.00,
  date: NaiveDateTime.new!(2024, 4, 18, 0, 0, 0),
  account: fee_revenue,
...
_debit_ds_5 = Repo.insert!(%Transaction{
  transaction_type: "debit",
  amount: 5.00,
  date: NaiveDateTime.new!(2024, 4, 18, 0, 0, 0),
  account: dwight_schrute_checking,
